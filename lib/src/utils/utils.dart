...
List<String> getStackTraceElements(StackTrace stackTrace) {
  ...
  return elements.map((Map<String, String> element) {
    final String file = element['file']!;
    final String line = element['line']!;
    final String method = element['method']!;
    final String clazz = element['class'] ?? '';
    return 'file: $file, line: $line, method: $method, class: $clazz';
  }).toList();
}
